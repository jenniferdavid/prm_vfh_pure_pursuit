...
while true
   ...
   % ********************************************************************* 
    ...
    %上--up
    if(row<nrows+1 && row-1>0 && column>0 && column<ncols && (color==3 || color==5))
    ...
    %下--down
    if(row+1<nrows+1 && row>0 && column>0 && column<ncols+1 && (color==3 || color==5))
    ...
    %左--left
    if(row<nrows+1 && row>0 && column-1>0 && column<ncols+1 && (color==3 || color==5))
    ...
    %右--right
    if(row<nrows+1 && row>0 && column>0 && column+1<ncols+1 && (color==3 || color==5))
